...
@interface JinshiViewController () <UITableViewDelegate, UITableViewDataSource, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation JinshiViewController
...
- (void)createTableView
{
    ...
    self.tableView.rowHeight = GTH(110);
...
{
    return [UIImage imageNamed:@"no_img"];
}
...
{
    static NSString *defaultCellID = @"jinshiTableViewCell";
