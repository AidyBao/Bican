...
@interface MessageInviteViewController () <UITableViewDelegate, UITableViewDataSource, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
- (void)RightNavigationButtonClick:(UIButton *)rightbtn
{
    ...
    NSString *messageStr = @"是否将所有的邀请标记为已读?";
...
{
    static NSString *defaultCellID = @"messageInviteTableViewCell";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    inviteVC.messageId = model.messageId;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (leftBottomSize.height >= GTH(90)) {
        return GTH(30) + leftTopSize.height + GTH(90) + 1 + GTH(20) * 3;

    } else {
        return GTH(30) + leftTopSize.height + leftBottomSize.height + 1 + GTH(20) * 3;
