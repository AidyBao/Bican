...
//
//  AttentionStudentViewController.m
//  Bican
//
...
@interface AttentionStudentViewController ()<UITableViewDataSource, UITableViewDelegate, DZNEmptyDataSetDelegate, DZNEmptyDataSetSource>
...
@implementation AttentionStudentViewController
...
- (void)attentionUser
{
    ...
    [params setValue:@"1" forKey:@"roleType"];
