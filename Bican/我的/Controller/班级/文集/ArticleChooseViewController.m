...
@interface ArticleChooseViewController ()<UITableViewDelegate, UITableViewDataSource, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate, ArticleChooseTableViewCellDelegate>
...
@implementation ArticleChooseViewController
...
- (void)selectedAllButtonAction:(UIButton *)sender
{
    ...
    for (int i = 0; i < self.dataSourceArray.count; i++) {
        ...
        if ([model.appraiseStatus isEqualToString:@"1"]) {
            //已评阅
            [self.cellSelectedArray replaceObjectAtIndex:i withObject:@""];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ArticleChooseTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:defaultCellID];
    if (!cell) {
        cell = [[ArticleChooseTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:defaultCellID];
    }
    ...
    [cell setArticleChooseCellWithBigType:model.bigTypeName
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([model.appraiseStatus isEqualToString:@"1"]) {//已评阅
        return;
    }
    ...
    ArticleChooseTableViewCell *cell = [tableView cellForRowAtIndexPath:indexPath];
    [cell setCellIsSelected:self.cellSelectedArray[indexPath.row]];
