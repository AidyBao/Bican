...
@implementation InvistToRecommedModel
...
{
    if (_developmentLevel == nil) {
        return @"";
    }
    if ([_developmentLevel isKindOfClass:[NSNumber class]]) {
        _developmentLevel = [NSString stringWithFormat:@"%@", _developmentLevel];
    }
...
- (NSString *)relation
{
    ...
    if ([_relation isKindOfClass:[NSNumber class]]) {
        _relation = [NSString stringWithFormat:@"%@", _relation];
    }
    return _relation;
}
